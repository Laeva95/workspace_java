...
/*클래스메소드*/
	...
	public void showSaleResult() {
		System.out.println("과일장수 객체의 현재 남은 사과수 : " + numOfApple);
		System.out.println("과일장수 객체의 현재 잔고 : " + myMoney);
	}
	
	// 3. 나중에 FruitSeller 클래스의 객체 메모리를 생성한 후 각 객체 변수 3개의 값을 저장할 기능의 메서드 추가
...
public class Ex1 {
	public static void main(String[] args) {
		...
		seller01.initMembers(1500, 30, 0);
		
		// 과일장수 2
		// 사과 20개 보유, 개당 가격 1000원
		FruitSeller seller02 = new FruitSeller();
		
		seller02.initMembers(1000, 20, 0);
		
		// 과일구매자
		FruitBuyer buyer01 = new FruitBuyer();
