...
//  답변3. 부모 클래스의 생성자를 먼저 실행하지 않으면 자식 클래스에서 초기화한 값이 덮어씌워질 수 있기 때문에
//
//  질문4. 부모 자료형 배열 하나에 서로 다른 자식 객체를 담을 수 있나요?
//  답변4. 가능하며 이를 업캐스팅이라고 함
//=====================================================================
...
class FullTimeEmployee extends Employee{
	...
	public void printPayslip(String month) {
		...
		System.out.println("성과\t: " + bonus);
		System.out.println("실지급\t: " + calculateSalary());
		System.out.println();
	}
...
class ContractEmployee extends Employee {
	private int hourlyWage, workHours;
	
	public ContractEmployee(String name, String empNo, String dept, int hourlyWage, int workHours) {
		super(name, empNo, dept);
	...
	public void printPayslip(String month) {
		...
		System.out.println("근무\t: " + workHours + "시간");
		System.out.println("실지급\t: " + calculateSalary());
		System.out.println();
	}
}
...
public class Test1 {
	public static void main(String[] args) {
		...
		employees[0] = new FullTimeEmployee("홍길동", "E001", "개발팀", 3000000, 500000);
		employees[1] = new ContractEmployee("김철수", "E002", "디자인팀", 15000, 120);
		employees[2] = new FullTimeEmployee("이영희", "E003", "기획팀", 2800000, 300000);

		int total = 0;
		//TODO 9. for 문으로 각 사원의 printPayslip("2026년 7월") 호출
		//        동시에 calculateSalary() 결과를 total 변수에 누적
		for(Employee e : employees) {
			e.printPayslip("2026년 7월");
			total += e.calculateSalary();
		}

		//TODO 10. 총 인원 수와 총 지급액 출력
		System.out.println("총 인원\t: " + employees.length + "명\n총 지급액\t: " + total + "원");
	}
}
