...
public class ButtonExample {
	...
	public static void main(String[] args) {
		...
		btnOK.setClickListner(new Button.ClickListener() {
			@Override
			public void onClick() { System.out.println("Button btnOK = new Button(); 버튼을 클릭했으니 선물을 줄게요!!"); }
		});
		...
		btnCancel.setClickListner(new Button.ClickListener() {
			@Override
			public void onClick() { System.out.println("<Button>Cancel</Button> 취소 버튼을 클릭했으니 집으로 가겠다."); }
		});
