...
class Order {
	...
	void printInfo() {
		...
		System.out.println(this.orderId + "번 주문 배송지 : " + address.full());
	}
}
...
public class OrderExample {
	public static void main(String[] args) {
		...
		new Order(1001, new Order.Address("부산", "해운대구 센텀로 1")).printInfo();
		new Order(1002, new Order.Address("부산", "해운대구 센텀로 1")).printInfo();
	}
}
