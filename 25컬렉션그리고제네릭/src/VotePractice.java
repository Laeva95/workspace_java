...
public class VotePractice {
	public static void main(String[] args) {
		...
		for(String id : validList) {
			int idx = candidateList.indexOf(id);
			if(idx == -1) {
				// 두개의 리스트에 동시에 add 메소드를 이용해서 요소를 추가
				// => 같은 index 값을 공유함
		...
		System.out.println("당선 : " + candidateList.get(maxIdx) 
		+ " (" + countList.get(maxIdx) + "표)");
